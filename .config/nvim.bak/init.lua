...
-- Disable automatic line wrapping on 80 characters.
vim.api.nvim_create_autocmd('BufEnter', {
  desc = 'Remove c and t from formatoptions',
  callback = function()
    local formatoptions = vim.opt_local.formatoptions:get()

    formatoptions = table.concat(formatoptions, '')

    formatoptions = formatoptions:gsub('[ct]', '')
...
require('lazy').setup({
  ...
  { -- Highlight, edit, and navigate code
    ...
    opts = {
      ensure_installed = { 'bash', 'c', 'diff', 'html', 'lua', 'luadoc', 'markdown', 'markdown_inline', 'query', 'vim', 'vimdoc', 'python', 'gdscript' },
...
end, { desc = 'Harpoon list [1]', noremap = true })
vim.keymap.set('n', '<leader>2', function()
  harpoon:list():select(2)
end, { desc = 'Harpoon list [2]', noremap = true })
vim.keymap.set('n', '<leader>3', function()
  harpoon:list():select(3)
end, { desc = 'Harpoon list [3]', noremap = true })
vim.keymap.set('n', '<leader>4', function()
  harpoon:list():select(4)
end, { desc = 'Harpoon list [4]', noremap = true })
